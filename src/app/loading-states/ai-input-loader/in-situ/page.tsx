                        ...
                        <>
                            <div className={styles.tableHeader}>
                                ...
                                <div className={styles.tableActions}>
                                    ...
                                    <button className={styles.actionButton} onClick={handleGenerateClick}>
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                        ...
                                        >
                                            ...
                                            <td>
                                                <div className={styles.typeCell}>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Varchar(16777216)">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.10097 3L4.31836 11H5.37712L6.07278 9H9.84055L10.5906 11H11.6586L8.65855 3H7.10097ZM9.46555 8H6.4206L7.88584 3.78744L9.46555 8Z" fill="currentColor"></path>
                                                        <path d="M4 14H12V13H4V14Z" fill="currentColor"></path>
                                                    </svg>
                                                    {row.type}
                                                </div>
                                            </td>
